...
const WriteArticle = () => {
  ...
  return (
    ...
    <div className="text-slate-700 dark:text-slate-300 flex justify-center gap-10 ">
      ...
      <div className="w-3/5  dark:text-slate-300 text-slate-700 px-8 py-6 ">
        <div className="flex justify-between text-sm font-semibold dark:text-slate-300 text-slate-700">
          ...
          <p>
            <span className="dark:text-primary-dark text-primary-light">{characterCount}</span>{" "}
            Words
          </p>
          <button className="rounded-3xl border-2 border-slate-300 dark:border-slate-700
